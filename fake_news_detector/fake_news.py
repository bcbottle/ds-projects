'''This was a practice project to build a 'fake news' detection algorithim. Code and data were provided by DatFlair (source: https://data-flair.training/blogs/advanced-python-project-detecting-fake-news/)

Notes in the code are mine to ensure I understood what steps were being taken.
